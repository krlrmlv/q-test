<template>
  <article>
    <h4 class="mb-24">{{ index }}. Цены продукции (prices)</h4>
    ...
    <SupportApiTabs :examples="examples">
      <template #description>
        ...
        <p class="mb-8">
          ...
          о&nbsp;ценах товаров торговой марки EKF.
        </p>

        <ul class="mb-32">
          <li><strong>Имя метода:</strong> prices.</li>
          <li>
        ...
        <p class="mb-8">URL:</p>
        <p class="code">
          https://ekfgroup.com/api/v1/ekf/catalog/prices?<span
            class="text-parameter"
            >vendor_code=rcbo6-1pn-1D-30-ac-av</span
          >
        </p>
          ...
          <pre class="mb-0">
{
    "data": [
        {
            "id": "0001cc0d-efa2-11e6-bd2e-000c29c6d5f2",
            "vendorCode": "rcbo6-1pn-1D-30-ac-av",
            "shortName": "DVA-6 1P+N  1А (D) 30мА (AC) 6кА EKF AVERES",
            "name": "Дифференциальный автомат DVA-6 1P+N  1А (D) 30мА (AC) 6кА EKF AVERES",
            "prices": [
                {
                    "priceType": {
                        "id": "5789da02-6acf-11e6-971e-000c29c6d5f2",
                        "name": "Казахстан  - из КЗ (KZT)",
                        "currency": "KZT"
                    },
                    "price": "532.00"
                },
                {
                    "priceType": {
                        "id": "6dcb3f5a-f670-11d8-b667-000a48086d14",
                        "name": "Базовая цена",
                        "currency": "руб."
                    },
                    "price": "120.00"
                ...
                {
                    "priceType": {
                        "id": "c250e6a3-b86b-11e5-8e48-000c29c6d5f2",
                        "name": "РРЦ",
                        "currency": "руб."
                    },
                    "price": "90.00"
      ...
      tableAttributes: [
        {
          ...
          example: '001db2c3-61e4-11dd-a91f-0080484601b3',
        },
        {
          attr: 'vendorCode',
          type: 'Строка',
        ...
        {
          description: 'Объект prices (цены)',
          header: true,
        },
        {
          attr: 'id',
          type: 'Строка',
          description: 'Уникальный идентификационный номер типа цены',
          example: '0001cc0d-efa2-11e6-bd2e-000c29c6d5f2',
        },
        {
          attr: 'name',
          type: 'Строка',
          description: 'Наименование типа цены',
          example: 'Базовая цена',
        },
        {
          attr: 'currency',
          type: 'Строка',
...
CURLOPT_URL => "https://ekfgroup.com/api/v1/ekf/catalog/prices?vendor_code=rcbo6-1pn-1D-30-ac-av",
...
payload = {'vendor_code': 'rcbo6-1pn-1D-30-ac-av'}
...
print(response.text)`,
        },
        {
          key: 'c',
          title: 'C#',
          text: `var client = new RestClient("https://ekfgroup.com/api/v1/ekf/catalog/prices?vendor_code=rcbo6-1pn-1D-30-ac-av");
...
.url("https://ekfgroup.com/api/v1/ekf/catalog/prices?vendor_code=rcbo6-1pn-1D-30-ac-av")
.get()
