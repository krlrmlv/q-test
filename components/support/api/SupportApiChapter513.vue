<template>
  <article>
    <h4 class="mb-24">{{ index }}. Продажи товаров Партнерами (sales)</h4>
    ...
    <SupportApiTabs :examples="examples">
      <template #description>
        ...
        <p class="mb-8">
          ...
          о&nbsp;продажах (без&nbsp;учета возвратов товара) товаров торговой
          марки EKF. Возможно предоставление данных как&nbsp;суммарно
          по&nbsp;всем юридическим лицам, так&nbsp;и&nbsp;отдельно
          по&nbsp;каждому юридическому лицу.
        </p>

        <ul class="mb-32">
          <li><strong>Имя метода:</strong> sales.</li>
          <li>
        ...
        <p class="mb-8">URL:</p>
        <p class="code">https://ekfgroup.com/api/v1/partners/sales</p>
...
print(response.text)`,
        },
        {
          key: 'c',
          title: 'C#',
          text: `var client = new RestClient("https://ekfgroup.com/api/v1/partners/sales");
